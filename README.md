...
The firmware drives all three coils with center-aligned sinusoidal PWM
(120 deg apart, generated by the ESP32-S3 MCPWM peripheral) to create a
rotating magnetic field.  Center-aligned (up-down counting) PWM naturally
staggers the switching edges of the three phases and all duty updates
are synchronized, which is important for reliable TMC6300 operation.
